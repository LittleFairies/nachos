 ...
 *                   *****************************************************************************************/
    ...
    if (variation) {
        ...
        for (i=0; i <= NUMVARS; i++) {
	    if (i == 3 || i == 4 || i == 6 || i == 7 || i == 8 || i == 9)	continue;
...
void route(int variation, char dbg_flag)   
{
    ...
    switch (variation)
    {
	    ...
	    char files[15][12] = {"file1.txt", "file2.txt", "file3.txt", "file4.txt", "file5.txt", "file6.txt", "file7.txt", "file8.txt", "file9.txt", "file10.txt", "file11.txt", "file12.txt", "file13.txt", "file14.txt", "file15.txt"};
